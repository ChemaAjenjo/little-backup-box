...
<img src="https://github.com/ChemaAjenjo/little-backup-box/blob/master/img/capture.gif" alt="" />
...
If you raspberry pi have internet connection, you can controle it with [Telegram Bot](https://telegram.org/blog/bot-revolution). For this you need [create a Telegram bot](https://core.telegram.org/bots#creating-a-new-bot). For this functionality you need run the next jarfile: [little-backup-bot](https://github.com/ChemaAjenjo/little-backup-bot/releases)
